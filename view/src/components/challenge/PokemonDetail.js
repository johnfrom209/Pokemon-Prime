                ...
                <div className="modal-body p-1 m-2">
                    ...
                    <div className="modal-footer absolute bottom-0 left-0 w-full">
                        <ul className="flex justify-center space-x-4 mb-4">
                            <li>
                                <button onClick={() => onGraveyard(pokemon)} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition duration-150 ease-in-out h-9">
                                    RIP
                                </button>
                            </li>
                            <li>
